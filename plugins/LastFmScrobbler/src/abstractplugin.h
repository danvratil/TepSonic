...
public:
    ...
    */
    void setHasConfigUI(const bool &state) {
        _hasConfigUI = state;
    }
...
public slots:
    ...
    */
    virtual void trackChanged(Player::MetaData metadata) {
        Q_UNUSED(metadata)
    }
    ...
    /*!
      ...
      \sa trackChanged()
    */
    virtual void trackFinished(Player::MetaData metadata) {
        Q_UNUSED(metadata)
    }
    ...
    */
    virtual void playerStatusChanged(Phonon::State newState, Phonon::State oldState) {
        Q_UNUSED(newState) Q_UNUSED(oldState)
    }
    ...
    */
    virtual void trackPositionChanged(qint64 newPos) {
        Q_UNUSED(newPos)
    }
