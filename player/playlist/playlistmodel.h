...
class PlaylistModel : public QAbstractItemModel
{
  ...
  public:
    ...
    */
    QModelIndex nextItem(const QModelIndex &index = QModelIndex()) const;
    ...
    */
    QModelIndex previousItem(const QModelIndex &index = QModelIndex()) const;
    ...
    */
    ...
    QModelIndex getStopTrack() const;
  ...
  public Q_SLOTS:
    ...
    */
    bool insertItem(const Player::MetaData &metadata, int row);
